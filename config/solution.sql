...
--
-- Host: localhost
-- Generation Time: Apr 24, 2015 at 02:22 PM
...
INSERT INTO `boxes` (`id`, `title`, `description`, `position`, `sort_order`, `is_active`, `created_at`) VALUES
...
INSERT INTO `files` (`id`, `type`, `item_id`, `title`, `file`, `is_active`, `sort_order`, `created_at`) VALUES
...
INSERT INTO `pages` (`id`, `parent_id`, `menu`, `route`, `controller`, `action`, `title`, `description`, `sort_order`, `is_active`, `created_at`) VALUES
...
INSERT INTO `projects` (`id`, `name`, `description`, `url`, `thumb`, `likes`, `sort_order`, `is_active`, `created_at`) VALUES
...
INSERT INTO `tags` (`id`, `title`, `sort_order`, `is_active`, `created_at`) VALUES
...
INSERT INTO `users` (`id`, `name`, `username`, `password`, `account_type`, `is_active`, `created_at`) VALUES
